var TableDatatables = function(){
    var handleCustomerTable = function(){
        var customerTable = $("#view-accepted-ticket");
//        alert("ok");
        var oTable = customerTable.dataTable({
            ...
            "ajax":{
                url:
                "http://localhost/ticket_raising/pages/scripts/resolver/manage-accepted-ticket.php",
                type: "POST",
            },
            "lengthMenu": [
                [5, 15, 20, -1],
        ...
        customerTable.on('click', '.edit', function(e) {
            ...
            $.ajax({
                url: "http://localhost/ticket_raising/pages/scripts/resolver/fetch-accepted.php",
                method: "POST",
                data: {ticket_id: $id},
                dataType: "json",
...
//                    $("#editModal").modal('show');
                    ...
                    window.location.href="http://localhost/ticket_raising/pages/reply.php";
                },
            });
