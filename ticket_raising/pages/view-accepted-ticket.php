...
-->
                                    ...
                                    <table class="table table-striped table-hover table-bordered" style="width:100%;" id="view-accepted-ticket">
                                        <thead>
                                            <tr>
                                                <th> Ticket id </th>
...
<!---->
    ...
    <script src="../assets/pages/scripts/manage-accepted-ticket.js"></script>
